...
const riderInput = async () => {
  if (input.value.length > 2) {
    riders.value = await (await fetch('http://localhost:3000/api/riders/search/' + input.value)).json();
  }
};
...
<template>
  ...
  <table>
    <tr>
      ...
      <th>Sprint</th>
      <th>Victoires</th>
      <th>Participations<br />Grands Tours</th>
      <th>Particiations<br />Classiques</th>
    </tr>
